...
The XGBoost model found that overall, **region of origin was the single strongest predictor for every destination category.** After region, the next most influential factors varied by destination:
...
The regions that impacted the classification in each category the most were widely varied across categories. For Northwest 5 schools, applicants from California, states other than Washington and Oregon, and the Bellingham area of Washington are more likely to attend. 

![Feature Importance for Northwest 5 School Destination.](/projects/capstone/nw5_shap_beeswarm.png)

![Impact of Applicant Region of Origin for Northwest 5 School Destination.](/projects/capstone/nw5_shap_cat_plot.png)

No model can say with certainty where a specific student will enroll. But across every approach we tried, a few clear and consistent patterns emerged about *what* tends to influence a student's choice. Using an applicant's region of origin, overall academic profile, and any financial information, one can gain a general understanding of where a student might enroll.

Additional features and destination categories are explored in the full write-up.
